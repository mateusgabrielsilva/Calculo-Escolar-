...
public class GeografiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesGeografia notes = new NotesGeografia();
        ...
        notes.b1 = settings.getFloat("geografia1",0);
        notes.b2 = settings.getFloat("geografia2",0);
        notes.b3 = settings.getFloat("geografia3",0);
        notes.b4 = settings.getFloat("geografia4",0);
        notes.f1 = settings.getFloat("geografia5",0);
        notes.f2 = settings.getFloat("geografia6",0);
        notes.f3 = settings.getFloat("geografia7",0);
        notes.f4 = settings.getFloat("geografia8",0);
        falta = settings.getFloat("geografia9", 0) ;
        bimestre = settings.getFloat("geografia10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("geografia1", notes.b1);
                editor.putFloat("geografia2", notes.b2);
                editor.putFloat("geografia3", notes.b3);
                editor.putFloat("geografia4", notes.b4);
                editor.putFloat("geografia5", notes.f1);
                editor.putFloat("geografia6", notes.f2);
                editor.putFloat("geografia7", notes.f3);
                editor.putFloat("geografia8", notes.f4);
                editor.putFloat("geografia9",falta) ;
                editor.putFloat("geografia10", bimestre);
                editor.commit();
