...
public class EducacaoFisicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educacao_fisica);
        ...
        final NotesEducacaoFisica notes = new NotesEducacaoFisica();
        ...
        notes.b1 = settings.getFloat("edFisica1",0);
        notes.b2 = settings.getFloat("edFisica2",0);
        notes.b3 = settings.getFloat("edFisica3",0);
        notes.b4 = settings.getFloat("edFisica4",0);
        notes.f1 = settings.getFloat("edFisica5",0);
        notes.f2 = settings.getFloat("edFisica6",0);
        notes.f3 = settings.getFloat("edFisica7",0);
        notes.f4 = settings.getFloat("edFisica8",0);
        falta = settings.getFloat("edFisica9", 0) ;
        bimestre = settings.getFloat("edFisica10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("edFisica1", notes.b1);
                editor.putFloat("edFisica2", notes.b2);
                editor.putFloat("edFisica3", notes.b3);
                editor.putFloat("edFisica4", notes.b4);
                editor.putFloat("edFisica5", notes.f1);
                editor.putFloat("edFisica6", notes.f2);
                editor.putFloat("edFisica7", notes.f3);
                editor.putFloat("edFisica8", notes.f4);
                editor.putFloat("edFisica9",falta) ;
                editor.putFloat("edFisica10", bimestre);
                editor.commit();
