...
public class ArtesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesArtes notes = new NotesArtes();
        ...
        notes.b1 = settings.getFloat("artes1",0);
        notes.b2 = settings.getFloat("artes2",0);
        notes.b3 = settings.getFloat("artes3",0);
        notes.b4 = settings.getFloat("artes4",0);
        notes.f1 = settings.getFloat("artes5",0);
        notes.f2 = settings.getFloat("artes6",0);
        notes.f3 = settings.getFloat("artes7",0);
        notes.f4 = settings.getFloat("artes8",0);
        falta = settings.getFloat("artes9", 0) ;
        bimestre = settings.getFloat("artes10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("artes1", notes.b1);
                editor.putFloat("artes2", notes.b2);
                editor.putFloat("artes3", notes.b3);
                editor.putFloat("artes4", notes.b4);
                editor.putFloat("artes5", notes.f1);
                editor.putFloat("artes6", notes.f2);
                editor.putFloat("artes7", notes.f3);
                editor.putFloat("artes8", notes.f4);
                editor.putFloat("artes9",falta) ;
                editor.putFloat("artes10", bimestre);
                editor.commit();
