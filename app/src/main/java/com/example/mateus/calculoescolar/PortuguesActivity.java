...
public class PortuguesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesPortugues notes = new NotesPortugues();
        ...
        notes.b1 = settings.getFloat("valor1",0);
        notes.b2 = settings.getFloat("valor2",0);
        notes.b3 = settings.getFloat("valor3",0);
        notes.b4 = settings.getFloat("valor4",0);
        notes.f1 = settings.getFloat("valor5",0);
        notes.f2 = settings.getFloat("valor6",0);
        notes.f3 = settings.getFloat("valor7",0);
        notes.f4 = settings.getFloat("valor8",0);
        falta = settings.getFloat("valor9", 0) ;
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("valor1", notes.b1);
                editor.putFloat("valor2", notes.b2);
                editor.putFloat("valor3", notes.b3);
                editor.putFloat("valor4", notes.b4);
                editor.putFloat("valor5", notes.f1);
                editor.putFloat("valor6", notes.f2);
                editor.putFloat("valor7", notes.f3);
                editor.putFloat("valor8", notes.f4);
                editor.putFloat("valor9",falta) ;
                editor.putFloat("valor10", bimestre);
                editor.commit();
