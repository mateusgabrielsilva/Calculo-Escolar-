...
public class HistoriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesHistoria notes = new NotesHistoria();
        ...
        notes.b1 = settings.getFloat("historia1",0);
        notes.b2 = settings.getFloat("historia2",0);
        notes.b3 = settings.getFloat("historia3",0);
        notes.b4 = settings.getFloat("historia4",0);
        notes.f1 = settings.getFloat("historia5",0);
        notes.f2 = settings.getFloat("historia6",0);
        notes.f3 = settings.getFloat("historia7",0);
        notes.f4 = settings.getFloat("historia8",0);
        falta = settings.getFloat("historia9", 0) ;
        bimestre = settings.getFloat("historia10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("historia1", notes.b1);
                editor.putFloat("historia2", notes.b2);
                editor.putFloat("historia3", notes.b3);
                editor.putFloat("historia4", notes.b4);
                editor.putFloat("historia5", notes.f1);
                editor.putFloat("historia6", notes.f2);
                editor.putFloat("historia7", notes.f3);
                editor.putFloat("historia8", notes.f4);
                editor.putFloat("historia9",falta) ;
                editor.putFloat("historia10", bimestre);
                editor.commit();
