...
public class QuimicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesQuimica notes = new NotesQuimica();
        ...
        notes.b1 = settings.getFloat("quimica1",0);
        notes.b2 = settings.getFloat("quimica2",0);
        notes.b3 = settings.getFloat("quimica3",0);
        notes.b4 = settings.getFloat("quimica4",0);
        notes.f1 = settings.getFloat("quimica5",0);
        notes.f2 = settings.getFloat("quimica6",0);
        notes.f3 = settings.getFloat("quimica7",0);
        notes.f4 = settings.getFloat("quimica8",0);
        falta = settings.getFloat("quimica9", 0) ;
        bimestre = settings.getFloat("valor10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("quimica1", notes.b1);
                editor.putFloat("quimica2", notes.b2);
                editor.putFloat("quimica3", notes.b3);
                editor.putFloat("quimica4", notes.b4);
                editor.putFloat("quimica5", notes.f1);
                editor.putFloat("quimica6", notes.f2);
                editor.putFloat("quimica7", notes.f3);
                editor.putFloat("quimica8", notes.f4);
                editor.putFloat("quimica9",falta) ;
                editor.putFloat("quimica10", bimestre);
                editor.commit();
