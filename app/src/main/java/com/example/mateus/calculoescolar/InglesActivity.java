...
public class InglesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesIngles notes = new NotesIngles();
        ...
        notes.b1 = settings.getFloat("ingles1",0);
        notes.b2 = settings.getFloat("ingles2",0);
        notes.b3 = settings.getFloat("ingles3",0);
        notes.b4 = settings.getFloat("ingles4",0);
        notes.f1 = settings.getFloat("ingles5",0);
        notes.f2 = settings.getFloat("ingles6",0);
        notes.f3 = settings.getFloat("ingles7",0);
        notes.f4 = settings.getFloat("ingles8",0);
        falta = settings.getFloat("ingles9", 0) ;
        bimestre = settings.getFloat("ingles10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("ingles1", notes.b1);
                editor.putFloat("ingles2", notes.b2);
                editor.putFloat("ingles3", notes.b3);
                editor.putFloat("ingles4", notes.b4);
                editor.putFloat("ingles5", notes.f1);
                editor.putFloat("ingles6", notes.f2);
                editor.putFloat("ingles7", notes.f3);
                editor.putFloat("ingles8", notes.f4);
                editor.putFloat("ingles9",falta) ;
                editor.putFloat("ingles10", bimestre);
                editor.commit();
