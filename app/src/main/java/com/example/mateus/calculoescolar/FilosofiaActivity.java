...
public class FilosofiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesFilosofia notes = new NotesFilosofia();
        ...
        notes.b1 = settings.getFloat("filosofia1",0);
        notes.b2 = settings.getFloat("filosofia2",0);
        notes.b3 = settings.getFloat("filosofia3",0);
        notes.b4 = settings.getFloat("filosofia4",0);
        notes.f1 = settings.getFloat("filosofia5",0);
        notes.f2 = settings.getFloat("filosofia6",0);
        notes.f3 = settings.getFloat("filosofia7",0);
        notes.f4 = settings.getFloat("filosofia8",0);
        falta = settings.getFloat("filosofia9", 0) ;
        bimestre = settings.getFloat("filosofia10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("filosofia1", notes.b1);
                editor.putFloat("filosofia2", notes.b2);
                editor.putFloat("filosofia3", notes.b3);
                editor.putFloat("filosofia4", notes.b4);
                editor.putFloat("filosofia5", notes.f1);
                editor.putFloat("filosofia6", notes.f2);
                editor.putFloat("filosofia7", notes.f3);
                editor.putFloat("filosofia8", notes.f4);
                editor.putFloat("filosofia9",falta) ;
                editor.putFloat("filosofia10", bimestre);
                editor.commit();
