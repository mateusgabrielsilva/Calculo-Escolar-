...
public class MatematicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesMatematica notes = new NotesMatematica();
        ...
        notes.b1 = settings.getFloat("matematica1",0);
        notes.b2 = settings.getFloat("matematica2",0);
        notes.b3 = settings.getFloat("matematica3",0);
        notes.b4 = settings.getFloat("matematica4",0);
        notes.f1 = settings.getFloat("matematica5",0);
        notes.f2 = settings.getFloat("matematica6",0);
        notes.f3 = settings.getFloat("matematica7",0);
        notes.f4 = settings.getFloat("matematica8",0);
        falta = settings.getFloat("matematica9", 0) ;
        bimestre = settings.getFloat("matematica10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("matematica1", notes.b1);
                editor.putFloat("matematica2", notes.b2);
                editor.putFloat("matematica3", notes.b3);
                editor.putFloat("matematica4", notes.b4);
                editor.putFloat("matematica5", notes.f1);
                editor.putFloat("matematica6", notes.f2);
                editor.putFloat("matematica7", notes.f3);
                editor.putFloat("matematica8", notes.f4);
                editor.putFloat("matematica9",falta) ;
                editor.putFloat("matematica10", bimestre);
                editor.commit();
