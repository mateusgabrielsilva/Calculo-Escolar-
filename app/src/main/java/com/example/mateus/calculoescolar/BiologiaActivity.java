...
public class BiologiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesBiologia notes = new NotesBiologia();
        ...
        notes.b1 = settings.getFloat("biologia1",0);
        notes.b2 = settings.getFloat("biologia2",0);
        notes.b3 = settings.getFloat("biologia3",0);
        notes.b4 = settings.getFloat("biologia4",0);
        notes.f1 = settings.getFloat("biologia5",0);
        notes.f2 = settings.getFloat("biologia6",0);
        notes.f3 = settings.getFloat("biologia7",0);
        notes.f4 = settings.getFloat("biologia8",0);
        falta = settings.getFloat("biologia9", 0) ;
        bimestre = settings.getFloat("biologia10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("biologia1", notes.b1);
                editor.putFloat("biologia2", notes.b2);
                editor.putFloat("biologia3", notes.b3);
                editor.putFloat("biologia4", notes.b4);
                editor.putFloat("biologia5", notes.f1);
                editor.putFloat("biologia6", notes.f2);
                editor.putFloat("biologia7", notes.f3);
                editor.putFloat("biologia8", notes.f4);
                editor.putFloat("biologia9",falta) ;
                editor.putFloat("biologia10", bimestre);
                editor.commit();
