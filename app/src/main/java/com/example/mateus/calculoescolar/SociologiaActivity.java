...
public class SociologiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NotesSociologia notes = new NotesSociologia();
        ...
        notes.b1 = settings.getFloat("sociologia1",0);
        notes.b2 = settings.getFloat("sociologia2",0);
        notes.b3 = settings.getFloat("sociologia3",0);
        notes.b4 = settings.getFloat("sociologia4",0);
        notes.f1 = settings.getFloat("sociologia5",0);
        notes.f2 = settings.getFloat("sociologia6",0);
        notes.f3 = settings.getFloat("sociologia7",0);
        notes.f4 = settings.getFloat("sociologia8",0);
        falta = settings.getFloat("sociologia9", 0) ;
        bimestre = settings.getFloat("sociologia10", 0);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putFloat("sociologia1", notes.b1);
                editor.putFloat("sociologia2", notes.b2);
                editor.putFloat("sociologia3", notes.b3);
                editor.putFloat("sociologia4", notes.b4);
                editor.putFloat("sociologia5", notes.f1);
                editor.putFloat("sociologia6", notes.f2);
                editor.putFloat("sociologia7", notes.f3);
                editor.putFloat("sociologia8", notes.f4);
                editor.putFloat("sociologia9",falta) ;
                editor.putFloat("sociologia10", bimestre);
                editor.commit();
